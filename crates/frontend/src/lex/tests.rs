...
fn tp_use_start() {
    match_tokens!(
        b"Struct<TypeParameter, AnotherTypeParameter>",
        [
            Span {
                value: Token::Identifier("Struct"),
                source: 0..6
            },
            Span {
                value: Token::TypeParameterUseStart,
                source: 6..7
            },
            Span {
                value: Token::Identifier("TypeParameter"),
                source: 7..20
            },
            Span {
            ...
            Span {
                value: Token::Identifier("AnotherTypeParameter"),
                source: 22..42
            },
            Span {
